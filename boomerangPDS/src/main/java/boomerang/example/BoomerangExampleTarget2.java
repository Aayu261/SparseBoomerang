...
public class BoomerangExampleTarget2 {
  public static void main(String... args) {
    ClassWithField a = new ClassWithField();   //object of classWithField a
    ClassWithField b = a;                      // Alias of object b with a
    NestedClassWithField n = new NestedClassWithField();   //object n of class nestedClassWithField
    n.nested = b;
    staticCallOnFile(n);          //call to method staticCallOnField
  }
